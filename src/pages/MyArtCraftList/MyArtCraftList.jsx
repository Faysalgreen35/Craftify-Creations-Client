...
// import { <MdOutlineStarRate />, MdOutlineStarRate } from "react-icons/md";
                ...
                fetch(`https://craftify-creations-server.vercel.app/updateCard/${_id}`, {
                    ...
                    .then(data => {
                        ...
                        if (data.deletedCount > 0) {
                            ...
                            const remaining = artsCrafts.filter(cof => cof._id !== _id);
                            setArtsCrafts(remaining);
                        }
                    });
            }
        });
                    ...
                    <div key={art.id} className="relative border border-gray-300 rounded bg-gray-300">
                        ...
                        <div className="p-4">
                            ...
                            <ul className="flex mb-2">
                                {/* Display rating */}
                                {createRatingArray(art.rating).map((star, index) => (
