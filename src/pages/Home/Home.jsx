...
const Home = () => {
    ...
    return (
        <div data-aos="fade-zoom-in" className=" bg-[#FAF3E8] dark:bg-gray-700">
            <Helmet>
                <title>Craftify Creations || Home</title>
            </Helmet>
            <div className='bg-red-400 banner rounded-xl'>
                ...
                <div data-aos="fade-up" className="text-center font-playfair font-bold  text-red-500 bg-slate-500 bg-opacity-50 mb-12" style={{ fontSize: '2rem' }}>
                    <Typewriter
                ...
                <h1 className="text-center    lg:py-36  font-bold lg:text-7xl mt-1 font-mono bg-slate-500 bg-opacity-50 mb-12">Welcome to <span className="font-bold  text-red-500 font-jacquard "><Typewriter
            ...
            <Banner></Banner>
            <div data-aos="flip" className="lg:max-w-6xl   text-black  mt-12 text-center mx-auto dark:bg-gray-800 dark:text-white ">
                <h1 className="text-center text-[#916211] font-extralight pt-12   font-playfair lg:text-9xl">
                    <span className="font-bold  text-yellow-700 font-playfair "><Typewriter
                        words={['+06']}
                        loop={5000}
                        cursor
                        cursorStyle='..'
                ...
                <p className="text-center font-inter font-bold text-black mt-12 dark:text-white md:text-3xl lg:text-5xl mb-4">Designed by artists, made <br /> by us, just for you.</p>
                <div data-aos="slide-up" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-8 lg:p-4 mx-auto lg:m-12">
            ...
            <section>
                <div className="lg:max-w-6xl   text-black  mt-12 text-center mx-auto dark:bg-gray-800 dark:text-white ">
                    ...
                    <h1 className="text-center text-[#916211] font-extralight pt-12   font-playfair lg:text-9xl">  <span className="font-bold  text-yellow-700 font-playfair "><Typewriter
                        words={['+06']}
                        loop={5000}
                        cursor
                        cursorStyle='..'
