...
const Banner = () => {
    ...
    return (
        <div data-aos="flip-right" className='md:max-w-6xl  lg:mt-12  '>
            ...
            >
                <SwiperSlide>
                    <div className="carousel-item relative w-full h-full" style={{ height: '400px' }}>
                        ...
                        <div className="absolute inset-0 flex flex-col   justify-center space-y-12 text-white text-left">
                            ...
                            <p className="z-10  text-left  text-base ml-12 lg:text-5xl xl:text-2xl font-bold lg:w-1/2 px-4">Landscape painting captures the essence of nature beauty, translating the vastness of the outdoors onto canvas.  </p>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                    <div className="carousel-item relative w-full h-full" style={{ height: '400px' }}>
                        ...
                        <div className="absolute inset-0 flex flex-col   justify-center space-y-12 text-white">
                            <div className="absolute inset-0 bg-black opacity-50"></div>
                            <p className="z-10 text-center text-base ml-12 lg:text-xl xl:text-2xl font-bold lg:w-1/2 px-4">Portrait drawing is a captivating art form that focuses on capturing the essence and personality of an individual through the careful rendering of their likeness. </p>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="carousel-item relative w-full h-full" style={{ height: '400px' }}>
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center space-y-12 text-white">
                            <div className="absolute inset-0 bg-black opacity-50"></div>
                            <p className="z-10 text-center text-base ml-12 lg:text-4xl xl:text-2xl font-bold lg:w-1/2 px-4">
